 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -9.5, -4.07 }
...
#define INVERT_E0_DIR true  // i don't use the cable adapter for the microswiss dd kit
...
#define Y_MIN_POS -10
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 30 // more space for the BL Touch
